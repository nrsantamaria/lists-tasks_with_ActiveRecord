...
describe(List) do
  ...
  describe("#tasks") do
    it("returns an array of tasks for that list") do
      test_list = List.new({:name => "Epicodus stuff", :id => nil})
      test_list.save()
      test_task = Task.new({:description => "Learn SQL", :due_date => '10-10-2010', :list_id => test_list.id()})
      test_task.save()
      test_task2 = Task.new({:description => "Review Ruby", :due_date => '10-10-2010', :list_id => test_list.id()})
      test_task2.save()
  ...
  describe("#delete") do
    ...
    it("deletes a list's tasks from the database") do
      list = List.new({:name => "Epicodus stuff", :id => nil})
      list.save()
      task = Task.new({:description => "learn SQL", :due_date => '10-10-2010', :list_id => list.id()})
      task.save()
      task2 = Task.new({:description => "Review Ruby", :due_date => '10-10-2010', :list_id => list.id()})
      task2.save()
      list.delete()
